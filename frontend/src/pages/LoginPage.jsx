        ...
        <div className="nb-window-split">
          ...
          <div className="nb-login-right">
            <div className="nb-form-header">
              ...
              {/* Interactive Demo Access with Animated Arrow Mark */}
              <div className="nb-demo-access-cluster">
                <button
                  type="button"
                  className="nb-demo-arrow-pointer"
                  onClick={() => handleStartAuth('demo')}
                  title="Click to enter instant demo mode"
                >
                  <span className="nb-demo-pointer-pill font-mono">
                    <span className="nb-pointer-live-dot" />
                    CLICK HERE FOR DEMO
                  </span>
                  <div className="nb-demo-arrow-anim">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 24 24"
