...
async def seed_canonical_intelligence():
    ...
    try:
        ...
        entities = [
            ...
            },
            {
                ...
                "properties": {
                    ...
                    "details": "Appears in UAE corporate registry filings as authorized signatory for maritime charter conduits.",
                    "case_id": "case-117"
                }
            },
            {
                ...
                "properties": {
                    "id": "p-ext-902",
                    "name": "R. K. Sharma (Customs Broker)",
                    ...
                    "details": "Registered customs clearing agent matching phone contact and shared Gujarat port footprint.",
                    "case_id": "case-108"
                }
            }
        ]
        ...
        evidence_items = [
            {
                ...
                "filename": "Bill_Of_Lading_BOL-9921-A_MV_Sagar_Ratna.txt",
                "file_hash": "9d20f76601f7edc1475e11acc64de99ae15507e9f0fa7936103c38f7aff51ddb",
                "file_size": 1932,
            ...
            {
                "id": "evd-2",
                "title": "AIS Transponder Telemetry (Arabian Sea)",
                "description": "Satellite AIS telemetry log showing transponder blackout and 1.4-meter draft reduction offshore Kandla.",
                "evidence_type": "document",
                "filename": "AIS_Transponder_Telemetry_Arabian_Sea_0922.csv",
                "file_hash": "f32c612fbc04a37bb6e287c321506e27af8315f648ec4fd488228f6c250e3f71",
                "file_size": 1037,
                "collected_at": "2026-09-22T21:30:00Z",
                "collected_by": "Coast Guard Maritime Surveillance",
                "case_id": "case-102"
            },
            {
                "id": "evd-3",
                "title": "FIU Hawala Mirror Ledger Account #88219",
                ...
                "filename": "FIU_Hawala_Mirror_Ledger_Account_88219.csv",
                "file_hash": "bad2f07597d298905e641eb9944a2114f9024de3e170a24c4c0bfe308c62b1df",
                "file_size": 1986,
        ...
        extra_entities = [
            ...
            ("evd-103", "Evidence", "case-117", {"id": "evd-103", "title": "Corporate Registry (Al-Barakah Logistics)", "evidence_type": "document", "filename": "Al_Barakah_Logistics_FZE_Corporate_Registry_Dubai.txt", "file_hash": "1188b0ab57e8f947a1f19d873edde15cd99ce41d6416e1b5c162208ba5d057c2", "file_size": 1407, "case_id": "case-117"}),
            ...
            ("evd-302", "Evidence", "case-108", {"id": "evd-302", "title": "9mm Glock Ballistics Striation Report", "evidence_type": "document", "filename": "Dock4_9mm_Glock_Forensic_Striation_Report.txt", "file_hash": "6f39f495b90677ed2f3db892feb41d768a6fdfbfc9d6242f4011811a0a6ac059", "file_size": 1563, "case_id": "case-108"}),
