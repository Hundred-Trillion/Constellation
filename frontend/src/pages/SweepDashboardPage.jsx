...
export default function SweepDashboardPage() {
  ...
  const [sweepCycle, setSweepCycle] = useState('AWAITING');
  const [itemsScanned, setItemsScanned] = useState(0);
  const [entitiesEvaluated, setEntitiesEvaluated] = useState(0);
  ...
  const loadLatestSweep = async () => {
    ...
    try {
      ...
      setItemsScanned(summary.items_scanned || (summary.findings || []).length);
      setEntitiesEvaluated(summary.entities_evaluated || summary.nodes_analyzed || 0);
      ...
      <div className="sweep-metrics-overview">
        ...
        <Panel3D maxAngle={6} glow="white" className="sweep-stat-panel3d">
          <div className="sweep-stat-card">
            ...
            <span className="stat-main-num font-mono">{itemsScanned.toLocaleString()}</span>
        ...
        <Panel3D maxAngle={6} glow="white" className="sweep-stat-panel3d">
          <div className="sweep-stat-card">
            ...
            <span className="stat-main-num font-mono">{entitiesEvaluated.toLocaleString()}</span>
